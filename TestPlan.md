...
2. Удалить список дел
3. Просмотреть список дел
4. Изменить список дел
...
Результаты тестирования представлены в документе [test](https://github.com/Artem13c/TRiTPO/blob/main/test.md).
